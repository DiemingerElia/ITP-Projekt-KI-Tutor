...
document.querySelector('main#tutor > div > button').addEventListener("click", function(event){
    ...
    let tutor = document.querySelector("#tutor select").value;
    SendMessage(tutor, ROLES[tutor]);
});
